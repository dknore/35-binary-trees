...
class BinarySearchTree {
  ...
  // Returns true if there are no nodes attached to the root of the tree. 
  // Returns false if there are any nodes in the tree.
  isEmpty() {
    if (this.root !== null) {
      return false;
    } 
  ...
  // Returns an array of all elements in the tree using an in-order traversal (left, current, right)
  toArray() {
    let accumulator = [];
  ...
  // Helper method that keeps track of the current node in the traversal and maintains a reference to the array accumulating values.
